...
crie um dicionário que mapeia inteiros de 3 a 20 para o seu dobro. Exemplo:
...
""""
Exercício 7: ================================================================
Utilize o dicionário criado no exercício 5. Para as chaves ímpares, não
queremos mais mapear para o seu sobro, mas sim, para o seu triplo. Consulte
o método keys() e atualize o seu dicionário para a nova regra.
"""
