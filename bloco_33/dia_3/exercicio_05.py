# ==============================================================================
# Exercício 5:
# Imagine que você tem a implementação de uma classe capaz
...
# capaz de renderizar imagens em SVG. Altere o código sem modificar a
# classe SvgImage , para que isso seja possível.

# Dica: Se você garantir que a imagem SVG seja renderizada utilizando
# a mesma interface que a imagem PNG, a imagem se tornará compatível.
# ==============================================================================
