"""
A herança não é o suficiente pra resolver nosso problema. Vamos trazer pro
palco, então, outra forma que temos de compartilhar códigos na Programação
Orientada a Objetos. A Composição !
"""
