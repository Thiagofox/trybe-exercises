// Exercicio 04 - Parte 1 - bloco 7 - Dia 3 -> Testes Unitários
...
assert.deepStrictEqual(myFizzBuzz(11), 11);
assert.deepStrictEqual(myFizzBuzz('treze'), false);
